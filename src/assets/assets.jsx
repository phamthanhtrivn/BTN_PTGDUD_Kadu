...
export const articles = [
  {
    ...
    image: "https://cdn3748.cdn-template-4s.com/thumbs/tin-tuc/blog-7_thumb_720_thumb_350.webp",
    content: [
      {
      ...
      {
        image: "https://cdn3039.cdn-template-4s.com/media/banner/1200x516_9608a3ee720a42f2ba378d95529c7693.webp",
      },
      {
  ...
  },
  {
    ...
    image: "https://cdn3748.cdn-template-4s.com/thumbs/tin-tuc/blog-6_thumb_720_thumb_350.webp",
    content: [
      {
      ...
      {
        subTitle: "1.1 Tìm kiếm sản phẩm mà bạn muốn mua trên website BITEXSHOP",
      ...
      {
        subTitle: "3. Mua hàng online tại website Bitex giao tận nhà, ưu đãi lớn",
  ...
  },
  {
    ...
    timeRelease: Date.parse("2022-10-10"),
    image: "https://cdn3748.cdn-template-4s.com/thumbs/tin-tuc/blog-2_thumb_720_thumb_350.webp",
    content: [
      {
  ...
  },
  {
    ...
    timeRelease: Date.parse("2022-10-10"),
    image: "https://cdn3748.cdn-template-4s.com/thumbs/tin-tuc/blog-9_thumb_720_thumb_350.webp",
    content: [
      {
        text: `Công ty VPP được thành lập từ năm 2000 kinh nghiệm trong lĩnh vực hoạt động văn phòng phẩm online và trực tiếp. Đội ngũ nhân viên có năng lực, nhiệt tình và tận tuỵ với công việc, hoạt động với phương trâm "Lợi ích của khách hàng luôn đặt lên hàng đầu".
          Hiện nay với công nghệ Internet phổ biến toàn cầu - Văn phòng phẩm VPP hoạt động với mục tiêu phục vụ tốt nhất nhu cầu của Quý khách hàng với tiêu chí là "Xem gì mua lấy"
