    ...
    <div className="container mx-auto mt-10 p-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
        <div className="md:col-span-2 bg-white p-6 shadow-lg rounded-lg">
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="flex gap-4">
              <button
                type="submit"
                className="w-30 bg-[#005E4F] text-white p-2 rounded-lg border border-transparent hover:bg-white hover:text-[#005E4F] hover:border-[#005E4F] cursor-pointer"
              >
                Gửi tin nhắn
              </button>
              <button
                ...
                className="w-30 bg-gray-500 text-white p-2 rounded-lg hover:bg-gray-700"
              >
          ...
          {showRequests && (
            <div className="mt-6 p-4 bg-gray-100 border rounded-lg">
              <h2 className="text-[#005E4F] font-bold mb-2">
                Danh sách yêu cầu
              </h2>
              {requests.length === 0 ? (
        ...
        <div className="bg-[#005E4F] text-white p-3 shadow-lg rounded-lg h-55 overflow-auto">
          <h5 className="text-lg mb-2">BẠN CẦN GẶP TRỰC TIẾP</h5>
          <br />
      ...
      <h2 className="text-2xl font-bold text-center mb-6 text-[#005E4F] mt-4">
        KHÁCH HÀNG & ĐỐI TÁC
      </h2>
      <div className="bg-white-100 py-3 shadow-lg rounded-lg">
        <div className="container mx-auto px-5 ">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
            <h3 className="text-xl font-semibold text-center mb-1 text-[#005E4F] border-b-2 border-blue-500 inline-block pb-1 w-fit mx-auto">
              KHÁCH HÀNG
            </h3>
            <h3 className="text-xl font-semibold text-center mb-1 text-[#005E4F] border-b-2 border-blue-500 inline-block pb-1 w-fit mx-auto">
              ĐƠN VỊ CUNG CẤP
            ...
            <div className="bg-gray-200 p-6">
              <p className="italic text-gray-600">
                “Công ty mình đã mua sản phẩm của Kadu được 02 năm nay, cảm thấy
                chất lượng rất tốt, nhân viên giao hàng nhiệt tình, chuyên
                nghiệp. Đặc biệt, sản phẩm luôn đảm bảo đúng tiêu chuẩn, bền bỉ
                và đáp ứng tốt nhu cầu sử dụng của công ty. Kadu không chỉ mang
                đến những sản phẩm chất lượng mà còn có dịch vụ chăm sóc khách
                hàng chu đáo, sẵn sàng hỗ trợ khi cần.”
              </p>
          ...
          <div className="mt-8 flex justify-center gap-15">
            ...
            <a
              href="https://www.tiktok.com/@fahasa_official"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2"
            >
